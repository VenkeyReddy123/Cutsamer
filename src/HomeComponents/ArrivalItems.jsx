        ...
        <>
            <div className=' container-fluid d-flex flex-row justify-content-between' style={{ overflow: 'hidden' }}>
                ...
                <div className='d-flex flex-row mr-2'>
                    <span className=' d-none d-md-block ml-4'>Features</span>
                    <span className=' d-none d-md-block ml-4'>Best Seller</span>
                    <span className=' d-none d-md-block ml-4'>Special Products</span>
                </div>
            </div>
            ...
            <div className='col-12 mt-5 container-fluid  d-flex flex-row' style={{ height: '400px', overflowX: 'auto', scrollbarWidth: 'none' }}>
                {Data2 && Data2.slice(2, 12).map((e, ind) => {
                    return (
                        <>
